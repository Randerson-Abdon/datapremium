...
<body>
    ...
    $titulo = 'SAAENET';
    $from = "suporte@saaecuruca.com.br";
    $dest = $email_contato;
    $headers = "From:" . $from;
    ...
    echo "<script language='javascript'>window.location='http://saaecuruca.com.br/curuca/web/home/index.php?acao=confirmar&codigo=$codigo_post&doc=$numero_cpf_cnpj'; </script>";
