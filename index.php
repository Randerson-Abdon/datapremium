...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">DataPremium <h6>Soluções em Tecnologia</h6></a></h1>
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p class="text-justify">
              A DataPremium é uma empresa de serviços de TI criada para possibilitar que os clientes utilizem a tecnologia a favor de seus negócios. Com o objetivo de prestar serviços e entregar soluções que proporcionam aos clientes desempenho e tranquilidade.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> Sites e Sistemas WEB Personalizados</li>
              <li><i class="ri-check-double-line"></i> Script Prontos para agilizar o desenvolvimento de seu projeto</li>
              <li><i class="ri-check-double-line"></i> Consultoria e Infraestrutura de Redes</li>
            </ul>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p class="text-justify">
              Além dos serviços de suporte em TI, a DataPremium é especialista em soluções avançadas de rede, infraestrutura, banco de dados, entre outras, e atua em parceria com os principais fabricantes de tecnologia do mundo.
              Essas soluções proporcionam aos clientes atualização tecnológica, aumento nos resultados e otimização de recursos sem dispersão de investimentos.
            </p>
        ...
        <div class="row">
          <div class="col-xl-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p class="text-center">Criação de Sites responsivos e personalizados ao estilo e necessidades de sua empresa.</p>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="">Sistemas WEB</a></h4>
              <p class="text-center">Seja pequena ou grande empresa, temos o sistema certo para você.</p>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="">Banco de Dados</a></h4>
              <p class="text-center">Soluções e gerenciamento de Banco de Dados, sempre com as melhores tecnologias do mercado.</p>
            </div>
          </div>
        ...
        <div class="row mt-4">
          <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <h4><a href="">Infraestrutura de Redes</a></h4>
              <p class="text-center">Soluções e configuração de redes gerenciaveis para sua empresa.</p>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><i class="bx bxl-dribbble"></i></div>
              <h4><a href="">Script Prontos</a></h4>
              <p class="text-center">Modelo de Scripts prontos para agilizar o desenvolvimento de seu projeto.</p>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4><a href="">Consultoria em TI</a></h4>
              <p class="text-center">Se você deseja informatizar sua empresa, temos profissionais protos para ajudar.</p>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
              ...
              <div class="member-info">
                <h4>Walter White</h4>
                <span>CEO</span>
                <p>Chefe Executivo e Gerente de desenvolvimento.</p>
                <div class="social">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
              ...
              <div class="member-info">
                ...
                <p>Gerente de marketing e apoio ao consumidor.</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="400">
              ...
              <div class="member-info">
                ...
                <p>Construção e gerenciamento de banco de dados.</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Endereço:</h4>
                <p>Alameda das Palmeiras, Bairro Parque Guajará, N° 531, Belém - PA - Brasil</p>
              </div>

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4>E-mail:</h4>
                <p>sac@datapremium.com.br</p>
              </div>

              <div class="phone">
                <i class="icofont-phone"></i>
                <h4>Telefone:</h4>
                <p>+55 91 98087-7159</p>
              </div>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>DataPremium Soluções em Tecnologia</span></strong>. Todos os direitos reservados
      </div>
      <div class="credits">
